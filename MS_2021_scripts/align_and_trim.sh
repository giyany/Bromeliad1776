...
bcftools filter --SnpGap 3 -i 'F_MISSING<0.4' Angio353_Ananas_aligned_allsamples_vcf_raw_primitives_ANAC.vcf.gz | bcftools view --exclude-types indels | bgzip > Angio353_Ananas_aligned_allsamples_vcf_filte
r_SnpGap_indels_missing0.4.vcf.gz; tabix Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4.vcf.gz;                                                                                      
                                                                                                                                                                                                             
#depth for genotype > 10 for site > 100                                                                                                                                                                      
                                                                                                                                                                                                             
~/Programs/vcflib/bin/vcffilter -f "DP > 100" -g "DP > 10" Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4.vcf.gz > Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missin
g0.4_DP10_100.vcf;                                                                                                                                                                                           
                                                                                                                                                                                                             
#at least 10 copies of the alternative allele present [but keep monomorphic sites]. This step removes all non-variant sites, so I extract them separatedly then concatenate together                         
                                                                                                                                                                                                             
bcftools filter -i 'AC>9 | AC==0' Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4_DP10_100.vcf | bcftools sort - | bgzip > Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels
_missing0.4_DP10_100_Nalt.vcf.gz; tabix Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4_DP10_100_Nalt.vcf.gz;                                                                         
bcftools view -C0 Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4_DP10_100.vcf | bcftools sort - | bgzip > Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4_DP10
_100_monoonly.vcf.gz; tabix Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4_DP10_100_monoonly.vcf.gz;                                                                                 
                                                                                                                                                                                                             
bcftools concat -a -D Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4_DP10_100_Nalt.vcf.gz Angio353_Ananas_aligned_allsamples_vcf_filter_SnpGap_indels_missing0.4_DP10_100_monoonly.vc
f.gz | bcftools sort - | bgzip > Angio353_Ananas_aligned_allsamples_withmono_filter_SnpGap_indels_missing0.4_DP10_100_Nalt.vcf;
